...
class Stock(models.Model):
    ...
    date_of_creation = models.DateTimeField(auto_now_add=False, blank=True, null=True)
...
class DatesValues(models.Model):
    ...
    stock = models.ForeignKey(Stock, on_delete=models.CASCADE, related_name='date_values')
